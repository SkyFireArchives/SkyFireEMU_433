...
enum MovementFlags
{
	...
	MOVEMENTFLAG_JUMPING               = 0x00001111, // this is invalid using as jumping in some scripts revert it when we find the correct MOVEMENTFLAG_JUMPING
    ...
    MOVEMENTFLAG_MASK_MOVING =
        ...
        MOVEMENTFLAG_PITCH_UP | /*MOVEMENTFLAG_JUMPING |*/ MOVEMENTFLAG_PITCH_DOWN | MOVEMENTFLAG_FALLING |
		MOVEMENTFLAG_ASCENDING | MOVEMENTFLAG_DESCENDING |MOVEMENTFLAG_FALLING_SLOW,
...
enum MovementFlags2
{
    ...
    MOVEMENTFLAG2_COLLISION                = 0x00000004,        // Overrides various clientside checks
    MOVEMENTFLAG2_FULL_SPEED_TURNING       = 0x00000008,
    MOVEMENTFLAG2_FULL_SPEED_PITCHING      = 0x00000010,
    MOVEMENTFLAG2_ALWAYS_ALLOW_PITCHING    = 0x00000020,
    MOVEMENTFLAG2_VEHICLE_EXIT_VOLUNTARY   = 0x00000040,
    MOVEMENTFLAG2_JUMP_IN_AIR              = 0x00000080,
    MOVEMENTFLAG2_ANIM_TIER_TRANS          = 0x00000100,
    MOVEMENTFLAG2_NO_SET_PITCH             = 0x00000200,
    MOVEMENTFLAG2_INTERPOLATED_MOVEMENT    = 0x00000400,
    MOVEMENTFLAG2_INTERPOLATED_TURNING     = 0x00000800,
    MOVEMENTFLAG2_INTERPOLATED_PITCHING    = 0x00001000,
    MOVEMENTFLAG2_VEHICLE_PASSENGER_TRANS_ALOWED = 0x00002000,
    MOVEMENTFLAG2_CAN_TRANS_SWIM_AND_FLY   = 0x00004000,
...
enum SplineFlags
{
    ...
    SPLINEFLAG_WALKING              = 0x00000200,
    SPLINEFLAG_FLYING               = 0x00000400,
    SPLINEFLAG_ROTATION_FIXED       = 0x00000800,
    SPLINEFLAG_FINAL_POINT          = 0x00001000,
    SPLINEFLAG_FINAL_TARGET         = 0x00002000,
    SPLINEFLAG_FINAL_FACING         = 0x00004000,
    SPLINEFLAG_CATMULL_ROM          = 0x00008000,
    SPLINEFLAG_CYCLIC               = 0x00010000,
    SPLINEFLAG_ENTER_CYCLE          = 0x00020000,
    SPLINEFLAG_ANIMATION            = 0x00040000,
    ...
    SPLINEFLAG_UNKNOWN24            = 0x00800000,
    SPLINEFLAG_INVERT_ORIENT        = 0x01000000,
    SPLINEFLAG_SMOOTH_PATHING       = 0x02000000,
    SPLINEFLAG_UNKNOWN27            = 0x04000000,
    SPLINEFLAG_UNKNOWN28            = 0x08000000,
    SPLINEFLAG_UNKNOWN29            = 0x10000000,
    SPLINEFLAG_UNKNOWN30            = 0x20000000,

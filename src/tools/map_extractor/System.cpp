...
uint32 CONF_TargetBuild = 15354;              // 4.3.3.15354
...
uint32 const Builds[] = {13164, 13205, 13287, 13329, 13596, 13623, 13914, 14007, 14333, 14480, 14545, 15005, 15050, 15211, 15354, 0};
